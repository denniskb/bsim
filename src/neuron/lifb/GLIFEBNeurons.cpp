...
NEURON_GPU_FUNC_BASIC(LIFEB)

int allocLIFEB(void *pCpu, int N)
{
...
int freeLIFEB(void *pCpu)
{
	GLIFEBNeurons *pCpuNeurons = (GLIFEBNeurons*)pCpu;
...
void mpiSendLIFEB(void *data, int rank, int offset, int size)
{
}

void mpiRecvLIFEB(void **data, int rank, int rankSize)
{
}
