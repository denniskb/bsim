...
int cudaAllocLIFEB(void *pCpu, void *pGpu, int num)
{
	GLIFEBNeurons *pGpuNeurons = (GLIFEBNeurons*)pGpu;
	GLIFEBNeurons *p = (GLIFEBNeurons*)pCpu;
...
int cudaFetchLIFEB(void *pGpu, void *pCpu, int num)
{
	GLIFEBNeurons *pGpuNeurons = copyFromGPU(static_cast<GLIFEBNeurons*>(pGpu), 1);
	GLIFEBNeurons *p = (GLIFEBNeurons*)pCpu;
