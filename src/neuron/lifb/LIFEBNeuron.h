#ifndef LIFEBNEURON_H
#define LIFEBNEURON_H

#include <stdio.h>
#include "../../base/NeuronBase.h"

class LIFEBNeuron : public NeuronBase {
public:
	LIFEBNeuron(real v_init, real v_rest, real v_reset, real cm, real tau_m, real tau_refrac, real tau_syn_E, real tau_syn_I, real v_thresh, real i_offset);
	LIFEBNeuron(const LIFEBNeuron &neuron);
	~LIFEBNeuron();
